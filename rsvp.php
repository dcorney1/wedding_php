...
<section class="sub-header" id="rsvp">
 ...
 <section class="travel" id="rsvpform">
    ...
    elseif (isset($_SESSION["families"])) {
     ...
     <select class=\"rsvp-select\" name=\"family\" id=\"familyID\" >";
      ...
      echo "</select>
      <button class=\"hero-btn red-btn rsvp-btn\" type=\"submit\" name=\"submit\">Submit</button>
      ...
      <button class=\"hero-btn logout-btn rsvp-btn\" type=\"submit\" name=\"submit\">Not Any of These?</button>
       ...
       if (isset($_SESSION["family_name"])) {
         ...
         <button class=\"hero-btn red-btn rsvp-btn\" type=\"submit\" name=\"submit\">RSVP</button>
         </form>";
       }
 ...
 <?php
  ...
  <form action="includes/contactform.inc.php" method="post" id="contact_form">
    <div class="name">
    ...
    <div class="submit">
      <input name="submit" type="submit" value="Send Message" id="form_button" />
      <input name="cancel" type="button" value="Close" id="form_button" onclick="closeForm()" />
    </div>
  </form>
  </div>
</section>  
