...
<section class="travel">
  ...
  <div class="row">
      ...
      <div class="travel-col">
        <h3><i class="fa fa-car" aria-hidden="true"></i>  Driving  <i class="fa fa-car" aria-hidden="true"></i></h3>
        <p>The Essex is a 3 hour and 15 minute drive from Boston, so flying into Boston Logan International Airport (BOS) is also an option.</p>
      </div>
  </div>
  <div class="date-header">
        <h1>Things to do</h1>
